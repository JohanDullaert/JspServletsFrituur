...
public class SausRepository {
	...
	// oef 10 MVC: er is nog geen sprake van toevoegen of verwijderen van suazen, 
	//dus concurrent lijkt me overbodig op deze moment (cursus is wel met create)
	...
	static {
		...
		SAUZEN.put(4L, new Saus(4, "tartare", new String[]{"mayo", "pikkels"}));
